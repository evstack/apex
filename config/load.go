...
data_source:
  # Data source type: "node" (Celestia DA node) or "app" (celestia-app Cosmos SDK gRPC)
  type: "node"
  ...
  # Path to celestia-app blockstore.db directory when backfill_source: "db".
  # Accepts either the blockstore dir itself, data dir, or node home dir.
  # celestia_app_db_path: "/home/user/.celestia-app/data/blockstore.db"

  # DB backend and key layout detection for blockstore reads.
  # celestia_app_db_backend: "auto"   # auto|pebble|leveldb
  # celestia_app_db_layout: "auto"    # auto|v1|v2
...
func validateDataSource(ds *DataSourceConfig) error {
	...
	case "app":
		...
		default:
			return fmt.Errorf("data_source.backfill_source %q is invalid; must be rpc|db", ds.BackfillSource)
		}
	default:
